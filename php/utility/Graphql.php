...
// KittyNetVpn SDK utility: graphql
//
...
class KittyNetVpnGraphql
{
    ...
    // equivalent.
    public static function body(KittyNetVpnContext $ctx): mixed
    {
    ...
    public static function errors(KittyNetVpnContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
