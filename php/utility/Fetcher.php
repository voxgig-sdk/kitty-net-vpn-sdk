...
// KittyNetVpn SDK utility: fetcher

class KittyNetVpnFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KittyNetVpnSDK/1.0)';
    ...
    public static function call(KittyNetVpnContext $ctx, string $fullurl, array $fetchdef): array
    {
