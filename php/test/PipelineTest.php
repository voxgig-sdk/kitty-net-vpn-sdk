...
{
    private static function utility(): KittyNetVpnUtility
    {
        return new KittyNetVpnUtility();
    }
    ...
    private static function ctx(array $over = []): KittyNetVpnContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KittyNetVpnContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KittyNetVpnOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KittyNetVpnError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KittyNetVpnOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KittyNetVpnMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KittyNetVpnOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KittyNetVpnMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KittyNetVpnOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KittyNetVpnMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KittyNetVpnSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KittyNetVpnMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KittyNetVpnResponse([]),
            'result' => new KittyNetVpnResult([]),
        ]);
        [, $err] = KittyNetVpnMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KittyNetVpnSpec([]),
            'response' => null,
            'result' => new KittyNetVpnResult([]),
        ]);
        [, $err] = KittyNetVpnMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KittyNetVpnSpec(['step' => 's']),
            'response' => new KittyNetVpnResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KittyNetVpnResult([]),
        ]);
        [, $err] = KittyNetVpnMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KittyNetVpnSpec(['step' => 's']),
            'response' => new KittyNetVpnResponse(self::resp(200, ['v' => 1])),
            'result' => new KittyNetVpnResult([]),
        ]);
        [, $err] = KittyNetVpnMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KittyNetVpnSpec(['step' => 's']),
            'response' => new KittyNetVpnResponse(self::resp(200, ['v' => 2])),
            'result' => new KittyNetVpnResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KittyNetVpnMakeResponse::call($ctx);
    ...
    {
        $preset = new KittyNetVpnResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KittyNetVpnSpec([]),
            'response' => new KittyNetVpnResponse([]),
            'result' => new KittyNetVpnResult([]),
        ...
        [$got, $err] = KittyNetVpnMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KittyNetVpnResult([])]);
        [, $err] = KittyNetVpnMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KittyNetVpnSpec([]), 'result' => null]);
        [, $err] = KittyNetVpnMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KittyNetVpnSpec(['step' => 's']),
            'result' => new KittyNetVpnResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KittyNetVpnOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KittyNetVpnMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KittyNetVpnSpec(['step' => 's']),
            'result' => new KittyNetVpnResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KittyNetVpnOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KittyNetVpnMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KittyNetVpnResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KittyNetVpnSpec([]),
            'result' => new KittyNetVpnResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KittyNetVpnMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KittyNetVpnMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KittyNetVpnError('boom', 'boom');
        $utility->fetcher = function (KittyNetVpnContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KittyNetVpnSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KittyNetVpnMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KittyNetVpnContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KittyNetVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KittyNetVpnResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        KittyNetVpnMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KittyNetVpnContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KittyNetVpnSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KittyNetVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KittyNetVpnResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KittyNetVpnSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KittyNetVpnMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KittyNetVpnMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KittyNetVpnMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KittyNetVpnResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KittyNetVpnDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KittyNetVpnResult(['ok' => false])]);
        $this->expectException(KittyNetVpnError::class);
        KittyNetVpnDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KittyNetVpnResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KittyNetVpnMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KittyNetVpnMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KittyNetVpnBaseFeature();
        $b = new KittyNetVpnBaseFeature();
        KittyNetVpnFeatureAdd::call($ctx, $a);
        KittyNetVpnFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KittyNetVpnBaseFeature
    {
        $f = new KittyNetVpnBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KittyNetVpnFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KittyNetVpnContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KittyNetVpnSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KittyNetVpnPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        KittyNetVpnPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KittyNetVpnResponse(['headers' => null]),
            'result' => new KittyNetVpnResult([]),
        ]);
        KittyNetVpnResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        KittyNetVpnResultBody::call($ctx);
