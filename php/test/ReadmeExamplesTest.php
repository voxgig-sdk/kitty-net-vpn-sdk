...
// KittyNetVpn SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KittyNetVpnSDK::test)
...
{
    private const SDK_CLASS = 'KittyNetVpnSDK';
    ...
    private const SDK_BASE = 'kittynetvpn_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kittynetvpn_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
