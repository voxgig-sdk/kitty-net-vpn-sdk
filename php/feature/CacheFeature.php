...
class KittyNetVpnCacheFeature extends KittyNetVpnBaseFeature
{
    ...
    private function _through(KittyNetVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
