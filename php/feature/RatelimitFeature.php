...
// KittyNetVpn SDK ratelimit feature
...
class KittyNetVpnRatelimitFeature extends KittyNetVpnBaseFeature
{
    ...
    private function _acquire(KittyNetVpnContext $ctx): void
    {
    ...
    private function _track(KittyNetVpnContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
