...
// KittyNetVpn SDK clienttrack feature
...
class KittyNetVpnClienttrackFeature extends KittyNetVpnBaseFeature
{
    ...
    public function PostConstruct(KittyNetVpnContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KittyNetVpn-SDK';
