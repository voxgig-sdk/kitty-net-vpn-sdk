# KittyNetVpn TypeScript SDK Reference

Complete API reference for the KittyNetVpn TypeScript SDK.
...
```ts
new KittyNetVpnSDK(options?: object)
```
...
#### `KittyNetVpnSDK.test(testopts?, sdkopts?)`
...
**Returns:** `KittyNetVpnSDK` instance in test mode.
...
Return the parent `KittyNetVpnSDK` instance.
