...
(0, node_test_1.describe)('ServerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.KittyNetVpnSDK({
    ...
    (0, node_test_1.test)('direct-list-server', async (t) => {
        ...
        const result = await client.direct({
            path: '01c6b4d1fccf-thankful-aisling/ext_config/remote-config.json',
            method: 'GET',
            params,
            query,
        });
...
function liveScenariosActive() { return false && process.env.KITTY_NET_VPN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.KittyNetVpnSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['KITTY_NET_VPN_TEST_SERVER_ENTID'];
    ...
    const client = new __1.KittyNetVpnSDK({
        base: 'http://localhost:8080',
