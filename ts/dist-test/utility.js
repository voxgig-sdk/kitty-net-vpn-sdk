...
function envOverride(m) {
    if ('TRUE' === process.env.KITTY_NET_VPN_TEST_LIVE ||
        'TRUE' === process.env.KITTY_NET_VPN_TEST_OVERRIDE) {
    ...
    m.KITTY_NET_VPN_TEST_EXPLAIN = process.env.KITTY_NET_VPN_TEST_EXPLAIN || m.KITTY_NET_VPN_TEST_EXPLAIN;
    return m;
}
