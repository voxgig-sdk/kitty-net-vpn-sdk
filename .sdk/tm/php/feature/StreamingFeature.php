...
// KittyNetVpn SDK streaming feature
...
class KittyNetVpnStreamingFeature extends KittyNetVpnBaseFeature
{
    ...
    private function _iterate(KittyNetVpnResult $result): \Generator
    {
    ...
    private function _streamable(KittyNetVpnContext $ctx): bool
    {
