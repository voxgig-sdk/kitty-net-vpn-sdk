...
class KittyNetVpnProxyFeature extends KittyNetVpnBaseFeature
{
    ...
    public function init(KittyNetVpnContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KittyNetVpnContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
