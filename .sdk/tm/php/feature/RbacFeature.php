...
class KittyNetVpnRbacFeature extends KittyNetVpnBaseFeature
{
    ...
    private function _required(KittyNetVpnContext $ctx): ?string
    {
    ...
    private function _reject(KittyNetVpnContext $ctx, string $required): void
    {
    ...
    private function _track(KittyNetVpnContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
