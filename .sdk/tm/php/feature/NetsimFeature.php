...
// KittyNetVpn SDK netsim feature
...
class KittyNetVpnNetsimFeature extends KittyNetVpnBaseFeature
{
    ...
    private function _simulate(KittyNetVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KittyNetVpnContext $ctx, array $applied): void
    {
        $client = $this->client;
