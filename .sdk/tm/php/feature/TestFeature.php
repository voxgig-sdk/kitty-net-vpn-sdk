...
// KittyNetVpn SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KittyNetVpnTestFeature extends KittyNetVpnBaseFeature
{
    ...
    public function init(KittyNetVpnContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KittyNetVpnContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KittyNetVpnParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KittyNetVpnContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KittyNetVpnContext $ctx, $op, $args): array
    {
