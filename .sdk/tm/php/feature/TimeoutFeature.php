...
// KittyNetVpn SDK timeout feature
...
class KittyNetVpnTimeoutFeature extends KittyNetVpnBaseFeature
{
    ...
    private function _with_timeout(KittyNetVpnContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KittyNetVpnContext $_ctx, float $ms): void
    {
        $client = $this->client;
