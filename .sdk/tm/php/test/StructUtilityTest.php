...
// KittyNetVpn SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = KittyNetVpnOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(KittyNetVpnOmni::structfix($now, Struct::undef()))
                        !== json_encode(KittyNetVpnOmni::structfix($val, Struct::undef()))) {
