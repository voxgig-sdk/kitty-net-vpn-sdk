...
class KittyNetVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KittyNetVpnTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = KittyNetVpnTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = KittyNetVpnTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
