...
class KittyNetVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KittyNetVpnTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = KittyNetVpnTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = KittyNetVpnTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
