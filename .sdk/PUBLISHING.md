...
|---|---|---|
| `ts/` | @voxgig-sdk/kitty-net-vpn-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/kitty-net-vpn-sdk \
      --repository voxgig-sdk/kitty-net-vpn-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/kitty-net-vpn-sdk` shows it, and
`npm trust revoke @voxgig-sdk/kitty-net-vpn-sdk --id=<id>` removes it.
