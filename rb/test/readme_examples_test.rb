...
#      offline in seeded test mode (KittyNetVpnSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "KittyNetVpn_sdk.rb")
  SDK_CLASS = "KittyNetVpnSDK"
