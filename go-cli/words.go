...
func registerSDKWords(r *eng.Registry, client *sdk.KittyNetVpnSDK) {
...
func runOp(client *sdk.KittyNetVpnSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
