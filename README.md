...
Kitty Net VPN client, generated from the OpenAPI spec.
...
Learn more about Kitty Net VPN at [github.com/l0v3m0n3y/kittyvpn](https://github.com/l0v3m0n3y/kittyvpn).

This is an unofficial SDK for the Kitty Net VPN public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
```bash
cd go-mcp && go build -o kitty-net-vpn-mcp .
```
...
```json
{
  "mcpServers": {
    "kitty-net-vpn": {
      "command": "/abs/path/to/kitty-net-vpn-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Server** | The Server entity (list). | `/01c6b4d1fccf-thankful-aisling/ext_config/remote-config.json` |
...
```go
import sdk "github.com/voxgig-sdk/kitty-net-vpn-sdk/go"
...
- Upstream API: [https://github.com/l0v3m0n3y/kittyvpn](https://github.com/l0v3m0n3y/kittyvpn)
...
Generated from the Kitty Net VPN OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
