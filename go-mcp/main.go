// Command KittyNetVpn-mcp is an MCP server exposing the KittyNetVpn
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KittyNetVpn_list  — list records of an entity
//	KittyNetVpn_load  — load a single record of an entity
//
