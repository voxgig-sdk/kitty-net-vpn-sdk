...
func registerTools(server *mcp.Server, client *sdk.KittyNetVpnSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kitty-net-vpn_list",
		Description: "List records from KittyNetVpn. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kitty-net-vpn_load",
		Description: "Load a single record from KittyNetVpn. " +
...
func runOp(client *sdk.KittyNetVpnSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KittyNetVpnSDK, name string) (sdk.KittyNetVpnEntity, error) {
