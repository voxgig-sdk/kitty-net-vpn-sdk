# KittyNetVpn SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KittyNetVpnSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KittyNetVpnSDK(...) and KittyNetVpnSDK.test(...) become
#      KittyNetVpnSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kittynetvpn_sdk"
_SDK_CLASS = "KittyNetVpnSDK"
