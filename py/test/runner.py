...
class KittyNetVpnTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KittyNetVpnTestRunner.getenv("KITTYNETVPN_TEST_LIVE")
        override = KittyNetVpnTestRunner.getenv("KITTYNETVPN_TEST_OVERRIDE")
        ...
        explain = KittyNetVpnTestRunner.getenv("KITTYNETVPN_TEST_EXPLAIN")
