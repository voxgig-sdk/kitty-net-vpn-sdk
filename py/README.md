# KittyNetVpn Python SDK



The Python SDK for the KittyNetVpn API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/kitty-net-vpn-sdk/releases)) or
...
```
py/
├── kittynetvpn_sdk.py         -- Main SDK module
