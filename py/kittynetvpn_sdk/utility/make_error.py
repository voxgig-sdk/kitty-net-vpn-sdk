...
def make_error_util(ctx, err):
    if ctx is None:
        from kittynetvpn_sdk.core.context import KittyNetVpnContext
        ctx = KittyNetVpnContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, KittyNetVpnError):
        errmsg = err.msg
    ...
    sdk_err = KittyNetVpnError("", msg, ctx)
