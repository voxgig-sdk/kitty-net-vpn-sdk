...
from kittynetvpn_sdk.core.control import KittyNetVpnControl
...
from kittynetvpn_sdk.core.helpers import get_ctx_prop, to_map
...
class KittyNetVpnContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, KittyNetVpnSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KittyNetVpnResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KittyNetVpnResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return KittyNetVpnError(code, msg, self)
