...
from kittynetvpn_sdk.utility import register

# Load features
from kittynetvpn_sdk.feature.base_feature import KittyNetVpnBaseFeature
from kittynetvpn_sdk.features import _has_feature, _make_feature
...
class KittyNetVpnSDK:
    ...
    def get_utility(self):
        return KittyNetVpnUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KittyNetVpnSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Server(self, data=None) -> "ServerEntity":
        ...
        from kittynetvpn_sdk.entity.server_entity import ServerEntity
        return ServerEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "KittyNetVpnSDK":
        if sdkopts is None:
            sdkopts = {}
